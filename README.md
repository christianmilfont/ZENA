...
- [ x ] (10 pts) Criar no mínimo 5 telas e utilizar navegação entre elas (React Navigation ou Expo Router): 
- [ x ] (40 pts) Implementar um CRUD utilizando a API criada na disciplina JAVA ou .NET (Axios ou Fetch).
- [ x ] (10 pts) Estilização do aplicativo, incluindo cores, fontes, e imagens personalizadas.
- [ x ] (20 pts) Arquitetura: será avaliada a organização dos arquivos, nomes das variáveis, funções e componentes utilizados.
- [ x ] (20 pts) Elabore uma gravação de um vídeo de todas as funcionalidades do Ap
